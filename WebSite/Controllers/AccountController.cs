...
namespace WebSite.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            var user = new ApplicationUser { UserName = model.Email, Email = model.Email, PhoneNumber = "", name = info.DefaultUserName, city = "Прокопьевск", adres = " " };
            var result = await UserManager.CreateAsync(user);
                if (result.Succeeded)
                {
                    ...
                    client.CustomerId = 0;
                    client.Adres = " ";
                    client.City = "Прокопьевск";
                    client.Name = info.DefaultUserName;
                    client.Phone = "";
                    client.Email = model.Email;
                    client.StartData = System.DateTime.Now;
                    client.Orders = new List<Order>();
